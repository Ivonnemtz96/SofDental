        ...
        <div class="row row-no-gutter packages-wrapper">
            ...
            <div class="col-sm-12 col-md-4 col-lg-4">
                <div class="pricing-package">
                    <div>
                        ...
                        <p class="package__desc">We provide all aspects of medical practice for your family, including
                            general
                            check-ups.</p>
                    ...
                    <div class="package__footer">
                        <div class="package__price">
                            <span class="package__currency">$</span><span>50</span><span
            ...
            <div class="col-sm-12 col-md-4 col-lg-4">
                <div class="pricing-package">
                    <div>
                        ...
                        <p class="package__desc">Fast project turnaround time, substantial cost savings & quality
                            standards.</p>
                        <ul class="package__list list-items list-items-layout2 list-unstyled">
                            <li>Review your medical records.</li>
                            <li>Check and test blood pressure.</li>
                    ...
                    <div class="package__footer">
                        <div class="package__price">
                            <span class="package__currency">$</span><span>70</span><span
                                class="package__period">/Month</span>
                        </div>
            ...
            <div class="col-sm-12 col-md-4 col-lg-4">
                <div class="pricing-package">
                    ...
                    <div class="package__footer">
                        <div class="package__price">
                            <span class="package__currency">$</span><span>90</span><span
                                class="package__period">/Month</span>
                        </div>
                        <a href="#" class="btn btn__secondary btn__rounded">Purchase Now</a>
                    </div><!-- /.package__footer -->
